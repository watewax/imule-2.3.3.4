...
PLOCALES="en_GB en_US es de fr it pl et_EE ru bg es_MX pt_BR gl eu nl ar fi zh_CN zh_TW da hu ca it_CH pt_PT hr sl ko_KR"
inherit eutils flag-o-matic readme.gentoo wxwidgets l10n user
...
SRC_URI="
	http://www.imule.i2p.rocks/files/download.php?Fichier=${MY_PNV}-src.tbz -> ${MY_PNV}-src.tbz
	http://echelon.i2p.xyz/imule/nodes.dat
"
RESTRICT="fetch"
...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="daemon -ed2k geoip i2p kde linkcreator mmap +nls stats upnp +webserver +X"
...
pkg_nofetch()
{
    ...
    echo " - ${MY_PNV}-src.tbz from ${HOMEPAGE}"
    echo "                  or from http://www.imule.i2p.rocks/files/download.php?Fichier=${MY_PNV}-src.tbz"
    echo " - nodes.dat from http://echelon.i2p.xyz/imule/nodes.dat"
